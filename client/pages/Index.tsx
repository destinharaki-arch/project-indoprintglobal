        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">
              Stickers That Express You
            </h1>

            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl">
              Discover thousands of high-quality stickers for your laptop, phone, water bottle, and more. Express your personality with our carefully curated collections from independent artists worldwide.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 mt-16 pt-16 border-t border-border/50">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">Unique Designs</p>
              </div>
              <div>
                <div className="text-3xl font-bold text-primary">48H</div>
                <p className="text-sm text-muted-foreground mt-2">Free Shipping</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Check out our most popular sticker collections loved by our community
          </p>
        </div>
      ...
      <footer className="bg-foreground text-background py-12 border-t border-border">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-bold text-lg mb-4">✨ Sticker Shop</h3>
              <p className="text-sm opacity-75">
                Your ultimate destination for high-quality, unique stickers from artists worldwide.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">Shop</h4>
              <ul className="space-y-2 text-sm opacity-75">
                <li><Link to="/shop" className="hover:opacity-100 transition">All Stickers</Link></li>
                <li><Link to="#" className="hover:opacity-100 transition">Categories</Link></li>
                <li><Link to="#" className="hover:opacity-100 transition">Best Sellers</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm opacity-75">
                <li><Link to="#" className="hover:opacity-100 transition">Privacy</Link></li>
                <li><Link to="#" className="hover:opacity-100 transition">Terms</Link></li>
                <li><Link to="#" className="hover:opacity-100 transition">Cookies</Link></li>
              </ul>
            </div>
          </div>
          
          <div className="border-t border-background/20 pt-8 text-center text-sm opacity-75">
            <p>&copy; 2024 Sticker Shop. All rights reserved. Crafted with care for sticker lovers.</p>
          </div>
        </div>
      </footer>
    </div>
